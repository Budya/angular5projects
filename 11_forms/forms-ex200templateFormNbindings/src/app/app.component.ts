...
@Component({
  selector: 'app-root',
  template: `
  <form #appointmentForm="ngForm" novalidate (ngSubmit)="onSubmitForm()">
  ...
  <div class="form-group">
      ...
      <textarea name="ailment" class="form-control" rows="3" [(ngModel)]="_ailment" required></textarea>
  </div>
  <button type="submit" class="btn btn-primary"
   [disabled]="!_appointmentForm.valid">Submit</button>
...
export class AppComponent {
  title = 'forms-ex200templateFormNbindings';
  ...
  onSubmitForm() {
    alert("Submitting data: " + JSON.stringify(
